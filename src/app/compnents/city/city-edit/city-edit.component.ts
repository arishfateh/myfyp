...
export class CityEditComponent implements OnInit {
  ...
  validation_messages = {
    CityName: [{ type: "required", message: "City Name is required." }],
    StayPriority: [{ type: "required", message: "StayPriority  is required." }],
    Latitude: [{ type: "required", message: "Latitude is required." }],
    Longitude: [{ type: "required", message: "Longitude is required." }],
    MaximumStop: [{ type: "required", message: "MaximumStop is required." }],
  };
