...
public catagory41=null;
  ...
  constructor(public dialog: MatDialog,config: NgbCarouselConfig,public router: Router, 
    private fb: FormBuilder, public attractionService: AttractionPointService,
     public cityService: CityService,
     public itineraryService: ItineraryService, public forall: ForallService,public hotelService: HotelService,
  ) {
...
console.log(this.hotelList.find(a=> a.City==inp),'filtered')
...
attractionordering(){
  ...
  SettingHotels(){
    // console.log("itinerary length in hotel",this.itinerary.length);
    // for(var i=0;i<this.itinerary.length;i++){
    //   console.log("hmmmdamsdmas");
    //     var a=this.hotelList.find(a=> a.City==this.tempday.cityname);
        
    //     console.log('hotels',this.hotelList.find(a=> a.City==this.tempday.cityname))
    //     console.log(a,"hotel list");
        
    //   this.itinerary[i].hotel=a[0];
    // }
  }
